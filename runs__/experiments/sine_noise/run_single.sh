#!/bin/bash
# Single Sine Noise experiment runner - runs one config with one run_id
# Usage: run_single.sh <config_file> <run_id> [gpu_id]
#
# Example: run_single.sh sine_noise_condition1_baseline.json 0 0
...
if [ -z "${CONFIG_FILE}" ] || [ -z "${RUN_ID}" ]; then
    ...
    echo ""
    echo "Example: run_single.sh sine_noise_condition1_baseline.json 0 0"
    exit 1
fi
...
CONDITION=$(echo "${CONFIG_BASE}" | sed -E 's/sine_noise_//' | sed -E 's/_.*//')
...
echo ""
echo "=========================================================================================================="
echo "SINE NOISE EXPERIMENT - NEW RUN"
echo "=========================================================================================================="
