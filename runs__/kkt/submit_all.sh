...
echo "[1/4] Submitting: SINE & MNIST - Conditions 1&2 (Baseline + Heuristics)"
...
echo "[2/4] Submitting: SINE & MNIST - Conditions 3&4 (Arch Search + AWB Full)"
...
echo "[3/4] Submitting: SYNTHETIC GRAPH - Conditions 1&2 (Baseline + Heuristics)"
...
echo "[4/4] Submitting: SYNTHETIC GRAPH - Conditions 3&4 (Arch Search + AWB Full)"
