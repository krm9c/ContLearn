...
def load_metrics_from_pkl(pkl_path):
    ...
    Only extracts main_training data, ignoring warmup/preliminary phases.
    """
    ...
    for task_id in range(n_tasks):
        ...
        # Extract main training data ONLY (ignores warmup, preliminary, A/B phases)
        if 'main_training' in task_data:
            ...
            metric_map = {
                ...
                'dV': 'dV',
                'grad_norm': 'grad_norm',
                'train_metric': 'train_acc',  # Classification uses accuracy
...
def main():
    """Main execution."""
    print("="*70)
    print("MNIST Condition Comparison Analysis (from PKL files)")
    print("="*70)
