#!/bin/bash
# Parallel sine experiments runner - runs multiple runs of all 4 conditions
...
# All sine config files (4 conditions)
CONFIGS=(
    "sine_condition1_baseline.json"
    "sine_condition2_heuristics.json"
    "sine_condition3_arch_no_transfer.json"
    "sine_condition4_awb_full.json"
)

echo ""
echo "=========================================================================================================="
echo "SINE EXPERIMENTS - MULTIPLE RUNS ACROSS 4 CONDITIONS"
echo "=========================================================================================================="
...
echo "SINE EXPERIMENTS - MULTIPLE RUNS" > "${SUMMARY_FILE}"
