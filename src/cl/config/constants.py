...
DEFAULT_TRANSFORMER_EMBED_DIM_STEP = 32
DEFAULT_TRANSFORMER_MLP_DIM_STEP = 64
DEFAULT_TRANSFORMER_LAYERS_RANGE = 2
DEFAULT_TRANSFORMER_HEAD_CANDIDATES = [2, 4, 8]
...
# Added by Claude: Architecture search method selection
# Options: 'grid' (default) or 'bayesian' (uses Optuna TPE sampler)
# Bayesian search typically evaluates 40-50% fewer candidates for similar results
DEFAULT_ARCH_SEARCH_METHOD = 'grid'
DEFAULT_ARCH_SEARCH_BO_TRIALS = 5  # Number of Optuna trials for Bayesian search
