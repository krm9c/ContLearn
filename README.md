# ContLearn: Continual Learning Framework

A modular JAX/Equinox-based framework for continual learning research implementing Hamiltonian gradient computation with Adaptive Weight Basis (AWB) for dynamic architecture morphing.
